...
const pizzahut = {name_:"PizzaHut", rating:"4.0", category: "Western", distance: "3km", openinghours: "8am - 10pm", status: "Open", image: pizzahutImg }; 
...
//dummy data (temporary)
const veggielovers = {name_:"Veggie Lovers", cost:"$10.80", quantity: "0", image: veggieloversImg }; 
const pepperoni = {name_:"Pepperoni", cost:"$17.30", quantity: "0", image: pepperoniImg };
const hawaiian = {name_:"Hawaiian", cost:"$16.70", quantity: "0", image: hawaiianImg };

const currychicken = {name_:"Curry Chicken", cost:"$17.30", quantity: "0", image: currychickenImg }; 
const garlicbread = {name_:"Garlic bread", cost:"$5.40", quantity: "0", image: garlicbreadImg };
const lasagna = {name_:"Lasagna", cost:"$9.60", quantity: "0", image: lasagnaImg };

function PizzahutPage(){
    return <div className={pizzahutCSS.pizzahut}>
